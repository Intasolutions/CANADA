...
const sponsors = [
  {
    ...
    name: "Eye N optics",
    description: "Eye Care for Eye Problems",
    companyInfo: "We Provide Comprehensive Eye examinaton and emergency Eye care and routine eye care for various Eye problems ",
    badge: "Mega Sponsor",
  },
  {
   id: 2,
...

  {
    ...
    {
    id: 4,
    image: "/sponsor/S-3.1.png",
    name: " Popular Home",
    description: "Genaral Contractor in  Belleville",
    companyInfo: "I am offering basement renovation, flooring framing, drywall works, garage insulation ,painting,",
    badge: "Gold Sponsor",
  },

   {
    id: 5,
  image: "/sponsor/S-1.1.png",
  ...
  {   id: 6,
   ...
   description: "We specialize in Physiotheraphy",
    ...
    {   id: 7,
    image: "/sponsor/s-7.1.png",
   name: "Thousand Spices",
   ...
   name: "Wellness zone Massages Therapy",
   description: "We specialize in Body Massage & Therapy",
    // companyInfo: "Physiotheraphy Specialist in canada",
...

  {
    ...
    {
    id: 10,
    image: "/sponsor/s-10.png",
    name: "Dr. Varghese Koshy  ",
    description: "Qma Member",
    ...
    {
    id: 11,
    image: "/sponsor/S-11.png",
    name: "Maple Blinds & Shades ",
    description: "63 S Front St, Belleville, ON K8N 5P4",
